...
if(isset($_POST['edit_category']))
{
    ...
    $update = "UPDATE `product_categories` SET `category_name`='$edit_category_name' WHERE category_id='$edit_category_id'";
    ...
    if(!$result){
        ...
        echo "<script>alert('Category Updated Successfully');window.location.href='admin_dashboard.php';</script>";
    }
...
<body style="font-family: 'Poppins', sans-serif;">
    ...
    <div class="">
                    ...
                    <div class="sm:w-[500px] sm:mx-auto items-start my-10">
                        <p class="text-[20px] text-[#222222] leading-[24px] font-semibold">Edit Category</p>
                                ...
                                <form action="edit_category.php" method="post" enctype="multipart/form-data">
                                    <div class="mt-6">
                                        <div class="my-2">
                                            ...
                                            <input type="text" name="edit_category_name" class="border h-[40px] rounded-sm px-3 w-full outline-none" value="<?php echo $row['category_name'];?>">
                                        </div>
                                        <input type="hidden" name="edit_category_id" value="<?php echo $row['category_id'];?>">
                                        <button type="submit" class="h-[40px] bg-black text-white w-[150px] text-center leading-[40px]" name="edit_category">Edit Category</button>
                                    </div>
                                </form>
                           <?php }
                        }
